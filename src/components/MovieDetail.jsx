...
//   return (
//     <div className="text-white bg-black/90 p-6 flex flex-col items-center justify-center max-w-[600px] mx-auto">
...
//       <span
//         key={genre.id}
//         className="bg-gray-700 text-white text-xm font-medium px-3 py-1 rounded-full"
//       >
//         {genre.name}
//       </span>
//     ))}
